...
for path in $dockerfiles; do
  ...
  docker tag "orangesys/alpine-influxdb-relay:${tag}" "asia.gcr.io/orange-sys/alpine-influxdb-relay:${tag}"
  sudo /opt/google-cloud-sdk/bin/gcloud docker push asia.gcr.io/orange-sys/alpine-influxdb-relay:${tag}
